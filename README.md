...
**Zephyr Watch** — это самодельные смарт-часы, построенные на базе **ESP32-S3-Zero-N4R2**, визуально и концептуально вдохновлённые Google Pixel Watch 3. Проект создан с целью максимально воспроизвести опыт использования Wear OS на доступном и открытом железе.
